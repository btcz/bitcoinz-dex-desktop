...
run_app(int argc, char** argv)
{
    ...
    app->setWindowIcon(QIcon(":/bitcoinz_defi_design/assets/images/logo/dex-logo.png"));
    ...
    engine.addImportPath("qrc:/bitcoinz_defi_design/imports");
    engine.addImportPath("qrc:/bitcoinz_defi_design/Constants");
    qmlRegisterSingletonType(QUrl("qrc:/bitcoinz_defi_design/qml/Constants/DexTheme.qml"), "App", 1, 0, "DexTheme");
    qmlRegisterSingletonType(QUrl("qrc:/bitcoinz_defi_design/qml/Constants/DexTypo.qml"), "App", 1, 0, "DexTypo");
    qmlRegisterSingletonType(QUrl("qrc:/bitcoinz_defi_design/qml/Constants/General.qml"), "App", 1, 0, "General");
    qmlRegisterSingletonType(QUrl("qrc:/bitcoinz_defi_design/qml/Constants/Style.qml"), "App", 1, 0, "Style");
    qmlRegisterSingletonType(QUrl("qrc:/bitcoinz_defi_design/qml/Constants/API.qml"), "App", 1, 0, "API");
    ...
    const QUrl url(QStringLiteral("qrc:/bitcoinz_defi_design/qml/main.qml"));
    QObject::connect(
